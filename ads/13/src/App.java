public class App {
    public static void main(String[] args) throws Exception {
        ...
        shirts[5] = "S006,Black T-Shirt,Black,XL"; shirts[6] = "S007,White TShirt,White,XL";
        ...
        Shirt[] shirt_objects = new Shirt[11];
        for (int i = 0; i<11; i++)
        {
            shirt_objects[i] = new Shirt(shirts[i]);
            System.out.println(shirt_objects[i]);
        }
    }
}
